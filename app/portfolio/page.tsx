                    ...
                    >
                      <div className="flex flex-col md:flex-row items-center gap-6">
                        ...
                        <div className="md:w-2/3 text-center md:text-left">
                          <h4 className="text-xl font-semibold mb-2">⌗ HOSHINO ⋮ サポート - My Channel</h4>
                          <p className="text-gray-400 mb-4">
                            A channel that publishes everything related to Hoshino Bot, programming codes, and bot updates.
                          </p>
